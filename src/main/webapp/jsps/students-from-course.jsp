...
<title>Student From Course Found</title>
</head>
<body>
<div>
    <table>
        ...
        <tbody>
            <c:forEach var="studentsFromCourse" items="${studentsFromCourse}">
                <tr>
                    <td>${course.id}&nbsp;</td>
                    <td>${student.id}&nbsp;</td>
                    <td><a href="${pageContext.request.contextPath}/delete-studentcourse?studentID=${course.id}&courseID=${student.id}">Delete</a>&nbsp;</td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
